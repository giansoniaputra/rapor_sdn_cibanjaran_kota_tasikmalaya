<?php include '../config/session-guru.php';
    ...
    if(isset($_POST["simpan"])){
        $query = query("SELECT * FROM absen_siswa RIGHT JOIN siswa ON absen_siswa.id_siswa = siswa.id_siswa WHERE tanggal = '$_POST[tanggal]' AND kelas = $_SESSION[guru]");
    } else{
        $query = query("SELECT * FROM absen_siswa RIGHT JOIN siswa ON absen_siswa.id_siswa = siswa.id_siswa WHERE tanggal = '$tgl' AND kelas = $_SESSION[guru] ");
    }

    $siswa = query("SELECT * FROM siswa WHERE kelas = '$_SESSION[guru]'");

    if(isset($_POST["submit"])){
        if (input_absen($_POST) > 0){
            echo "  
            <script>
                
                document.location.href= 'absen-siswa.php?tanggal=$_POST[tanggal]'
		    </script>
		";
    }else {
		echo "
                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="mt-3 mt-md-0">
                            <button type="button" class="btn btn-success waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#custom-modal"><i class="mdi mdi-plus-circle me-1"></i> Tambah Absensi </button>
                        </div> <br><br>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <form action="" method="post" style="display:inline;">
                                                <div class="row">
                                                    <div class="col-md-9">
                                                        <label class="mb-1 fw-bold text-muted">Pilih Tanggal</label>
                                                        <input type="date" name="tanggal" class="form-control" />
                                                     </div> <!-- end col -->
                                                    <div class="col-md-2">
                                                        <br>
                                                        <button type="submit" class="btn btn-success waves-effect waves-light" name="simpan" style="top:6px">Save</button>
                                                    </div>
                                                 </div> <!-- end row -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="mt-0 header-title">Absensi Siswa</h4>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header bg-light">
                        <h4 class="modal-title" id="myCenterModalLabel">Tambah Absensi Siswa</h4>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="tanggal"  name="tanggal" required onchange="autofill()">
                        </div>

                        <div class="mb-3">
                            <label for="id_siswa" class="form-label">Nama Siswa</label>
                                <select class="form-control" data-toggle="select2" data-width="100%" name="id_siswa" id="id_siswa" required onchange="autofill()"> 
                            ...
                            <div class="mb-3">
                                ...
                                <select id="hadir" name="kehadiran" class="form-control">
...
<footer class="footer">
        ...
        <script type="text/javascript">
            function autofill(){
                ...
                var id_mapel = $("#tanggal").val();
                $.ajax({
                    url : 'auto-absen.php',
                    data : {'id_siswa':id_siswa,'tanggal':id_mapel},
                }).success(function(data){
                    var json = data,
                    obj =JSON.parse(json);
                    $("#hadir").val(obj.kehadiran);
