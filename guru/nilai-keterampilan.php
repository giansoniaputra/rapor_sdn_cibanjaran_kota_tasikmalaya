...
<?php 
    ...
    $id_mapel = $data["id_mapel"];
        ...
        $query = query("SELECT * FROM nilai_keterampilan 
        LEFT JOIN mapel ON nilai_keterampilan.id_mapel = mapel.id_mapel 
        LEFT JOIN siswa ON nilai_keterampilan.id_siswa = siswa.id_siswa
    ...
    if(isset($_POST["submit"])){
        if (tambah_nilai_2($_POST) > 0){
            echo "
            <script>
                alert('Data Mata Pelajaran Berhasil Ditambahkan')
                document.location.href= 'nilai-keterampilan.php?id=$data[nama_mapel]'
		    </script>
		";
    }else {
		echo "
                    ...
                    <br>
                        ...
                        <div class="row">
                            ...
                            <?php foreach($mapel as $row): ?>
                                    <a href="nilai-keterampilan.php?id=<?= $row["nama_mapel"] ?>"><button type="button" class="btn btn-success width-md waves-effect waves-light"><?= $row["nama_mapel"]; ?></button></a>
                            <?php endforeach; ?> 
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="mt-0 header-title">Data Mata Pelajaran <?= $data["nama_mapel"] ?></h4>
